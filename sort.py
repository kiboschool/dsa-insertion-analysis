...
if __name__ == "__main__":
    ...
    lst = Sort.almost_sorted_list(1000)
    sort.insertion_sort(lst)
    print("comparisons: " + str(sort.get_comps()))
    print("moves: " + str(sort.get_moves()))
    sort.reset_stats()
    ...
    print("insertion sort on an almost sorted list\n")
    lst = Sort.almost_sorted_list(2000)
    sort.insertion_sort(lst)
    print("comparisons: " + str(sort.get_comps()))
    print("moves: " + str(sort.get_moves()))
    sort.reset_stats()
    ...
    print("insertion sort on an almost sorted list\n")
    lst = Sort.almost_sorted_list(4000)
    sort.insertion_sort(lst)
    print("comparisons: " + str(sort.get_comps()))
    print("moves: " + str(sort.get_moves()))
    sort.reset_stats()
